...
const SvgBrickWall: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  pathProps,
  ...
  >
    ...
    <AnimatedPath d="M12 9v6" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M16 15v6" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M16 3v6" animatedProps={animatedProps} {...pathProps} />
