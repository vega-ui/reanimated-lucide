...
const SvgTextSelect: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  svgProps,
  ...
  >
    ...
    <AnimatedPath d="M7 16h6" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M7 8h8" animatedProps={animatedProps} {...pathProps} />
