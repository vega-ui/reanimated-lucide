...
const SvgListX: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  pathProps,
  ...
  >
    ...
    <AnimatedPath d="m19 10-4 4" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="m15 10 4 4" animatedProps={animatedProps} {...pathProps} />
  </AnimatedSvg>
);
