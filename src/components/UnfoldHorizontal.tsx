...
const SvgUnfoldHorizontal: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  svgProps,
  ...
  <AnimatedSvg
    ...
    {...props}
  >
    <AnimatedPath d="M16 12h6" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M8 12H2" animatedProps={animatedProps} {...pathProps} />
