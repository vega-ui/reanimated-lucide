...
const SvgNotebookText: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  svgProps,
  ...
  >
    ...
    <AnimatedPath d="M9.5 8h5" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M9.5 12H16" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M9.5 16H14" animatedProps={animatedProps} {...pathProps} />
  </AnimatedSvg>
);
