...
const SvgFoldHorizontal: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  pathProps,
  ...
  <AnimatedSvg
    ...
    {...props}
  >
    <AnimatedPath d="M2 12h6" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="M22 12h-6" animatedProps={animatedProps} {...pathProps} />
