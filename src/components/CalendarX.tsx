...
const SvgCalendarX: React.FC<AnimatedSvgProps> = ({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  svgProps,
  ...
  >
    ...
    <AnimatedPath d="m14 14-4 4" animatedProps={animatedProps} {...pathProps} />
    <AnimatedPath d="m10 14 4 4" animatedProps={animatedProps} {...pathProps} />
  </AnimatedSvg>
);
