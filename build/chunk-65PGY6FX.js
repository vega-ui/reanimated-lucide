...
var SvgSwords = ({
  ...
  AnimatedSvg,
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("line", { x1: 5, x2: 9, y1: 14, y2: 18 }),
      /* @__PURE__ */ jsx("line", { x1: 7, x2: 4, y1: 17, y2: 20 }),
      /* @__PURE__ */ jsx("line", { x1: 3, x2: 5, y1: 19, y2: 21 })
    ]
  }
);
var Swords_default = SvgSwords;

export { Swords_default };
